...
func NewData(c *conf.Data, logger log.Logger) (*Data, func(), error) {
	...
	kafkaProducer, err := setupKafkaProducer(c.Kafka.Brokers)
	if err != nil {
		log.Errorf("failed to setup kafka producer: %v", err)
		return nil, nil, err
	}
...
// setupKafkaProducer sets up a Kafka producer
func setupKafkaProducer(brokers []string) (sarama.SyncProducer, error) {
